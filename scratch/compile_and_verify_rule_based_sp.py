...
def update_and_test(db_name):
    ...
    try:
        ...
        print(f"Compiling updated stored procedure in {db_name}...")
        cursor.execute(sp_ddl)
        conn.commit()
        print("Compilation successful.")
        
        # Test executing it
        print(f"Executing sp_Level_AutoUpdateHistory in {db_name}...")
...
update_and_test("Vietinsoft_ForTest")
update_and_test("Paradise_Dev")
