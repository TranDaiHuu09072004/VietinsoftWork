...
CREATE   PROCEDURE [dbo].sp_MainStyleCSSParadise
...
:root {
    ...
    --paradise-color-primary: #1d9336;             /* Paradise Green accent */
    ...
    --paradise-bg-primary-subtle: rgba(29, 147, 54, 0.16);
    ...
    --paradise-bg-header1-subtle: rgba(29, 147, 54, 0.18);
    ...
    --paradise-color-logo-main: #1d9336;
    --paradise-color-text-bg: #1d9336;
    --paradise-color-header1: #1d9336;
    ...
    --paradise-color-btnexport: #1d9336;
    ...
    --paradise-color-input-focus-ring: rgba(29, 147, 54, 0.35);

    --paradise-color-checkbox: #1d9336;
    --paradise-color-checkbox-border: #1d9336;
    --paradise-color-checkbox-border-hover: rgba(29, 147, 54, 0.55);
...
:where(button, a, input, textarea, select,
       .btn, .card, .vts-card, .data-setting-button,
       .vts-btn, .dx-button, .dx-checkbox-icon) {
...
/* Cell value: monospace nếu container có class .vts-data-mono */
.vts-data-mono,
.vts-data-mono .dx-datagrid-rowsview td,
.dx-datagrid.vts-data-mono .dx-datagrid-text-content {
    font-family: var(--paradise-font-family-mono);
}

/* ====================================================================
   SECTION 5 — BUTTONS
   New BEM modifier classes: .vts-btn--lg, .vts-btn--reload, ...
...
:where(.data-setting-button, .vts-btn, .btn):hover {
    filter: brightness(1.1);
}

[data-bs-theme="light"] :where(.data-setting-button, .vts-btn, .btn):hover {
    filter: brightness(0.9);
}

/* Size variants — BEM modifier (mới) + alias (legacy) */
:where(.vts-btn--lg, .vts-btn-lg /* [LEGACY] */, .btn-lg) {
    --paradise-btn-padding-y: 0.875rem;
    --paradise-btn-padding-x: 1.25rem;
    --paradise-btn-font-size: var(--paradise-font-button-lg);
}
:where(.vts-btn--xl, .vts-btn-xl /* [LEGACY] */, .btn-xl) {
...
:where(.vts-btn--sm, .vts-btn-sm /* [LEGACY] */, .btn-sm) {
...
.btnreload, .vts-btn-reload, .vts-btn--reload,
.btnfwadd, .vts-btn-add, .vts-btn--add,
.btnfwsave, .vts-btn-save, .vts-btn--save,
.btnfwdelete, .vts-btn-delete, .vts-btn--delete,
.btnfwreset, .vts-btn-reset, .vts-btn--reset,
.btnexport, .vts-btn-export, .vts-btn--export, .data-setting-button-export,
.btnimport, .vts-btn-import, .vts-btn--import, .data-setting-button-import,
...
/* ====================================================================
   ...
   ==================================================================== */
.vts-text-primary   { color: var(--paradise-color-primary); }
.vts-text-secondary { color: var(--paradise-color-secondary); }
.vts-text-success   { color: var(--paradise-color-success); }
.vts-text-danger    { color: var(--paradise-color-danger); }
.vts-text-warning   { color: var(--paradise-color-warning); }
.vts-text-info      { color: var(--paradise-color-info); }
.vts-text-dark      { color: var(--paradise-text-body); }
.vts-text-muted     { color: var(--paradise-text-muted); }

/* Semantic shortcut classes (theo styles.css: .pos / .neg / .muted) */
.vts-pos    { color: var(--paradise-color-success) !important; }
.vts-neg    { color: var(--paradise-color-danger) !important; }
.vts-muted  { color: var(--paradise-text-muted); }

.vts-bg-primary-subtle   { background-color: var(--paradise-bg-primary-subtle); }
.vts-bg-secondary-subtle { background-color: var(--paradise-bg-secondary-subtle); }
.vts-bg-success-subtle   { background-color: var(--paradise-bg-success-subtle); }
.vts-bg-danger-subtle    { background-color: var(--paradise-bg-danger-subtle); }
.vts-bg-warning-subtle   { background-color: var(--paradise-bg-warning-subtle); }
.vts-bg-info-subtle      { background-color: var(--paradise-bg-info-subtle); }
.vts-bg-dark-subtle      { background-color: var(--paradise-bg-dark-subtle); }
.vts-bg-light-subtle     { background-color: var(--paradise-bg-light-subtle); }
.vts-bg-header1-subtle   { background-color: var(--paradise-bg-header1-subtle); }
.vts-bg-header2-subtle   { background-color: var(--paradise-bg-header2-subtle); }
.vts-bg-important-subtle { background-color: var(--paradise-bg-important-subtle); }
...
.vts-badge--success { background: var(--paradise-bg-success-subtle); color: var(--paradise-color-success); }
.vts-badge--error,
.vts-badge--danger  { background: var(--paradise-bg-danger-subtle);  color: var(--paradise-color-danger); }
.vts-badge--warn,
.vts-badge--warning { background: var(--paradise-bg-warning-subtle); color: var(--paradise-color-warning); }
.vts-badge--info    { background: var(--paradise-bg-info-subtle);    color: var(--paradise-color-info); }
.vts-badge--primary { background: var(--paradise-bg-primary-subtle); color: var(--paradise-color-primary); }
...
.vts-kpi__value.vts-pos { color: var(--paradise-color-success); }
.vts-kpi__value.vts-neg { color: var(--paradise-color-danger); }
.vts-kpi__sub {
...
.vts-fade-in { animation: vtsFadeIn 0.3s ease; }
...
@media (max-width: 480px) {
    ...
    .vts-kpi-grid { grid-template-columns: 1fr; }
    .vts-kpi { padding: var(--paradise-space-3); }
    .vts-kpi__value { font-size: 16px; }
}
...
@media (min-width: 481px) and (max-width: 768px) {
    ...
    .vts-kpi-grid { grid-template-columns: 1fr 1fr; }
}
