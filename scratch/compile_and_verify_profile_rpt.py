...
script_path = r"d:\VTS User\Cuong.vu\Agent work\VietinsoftWork\SQL script\create_rpt_EmployeeProfileSalaryContract.sql"
...
try:
    ...
    # 3. Test execution for 2025-01-31
    print("\n=== Test Executing dbo.sp_Report_EmployeeProfileSalaryContract_ByDate for 2025-01-31 ===")
    cursor.execute("EXEC dbo.sp_Report_EmployeeProfileSalaryContract_ByDate @LoginID = 3, @ViewDate = '2025-01-31'")
