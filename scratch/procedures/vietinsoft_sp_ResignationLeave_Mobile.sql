CREATE procedure [dbo].[sp_ResignationLeave_Mobile](@LoginID int=3, @LanguageID varchar(2) ='VN', @Identity_Id varchar(36) ='')
as
set nocount on
...
function RenderHtmlLeaveRequest(arr) {
    ...
    <img _param='' ${e.PhotoImage}'' loading="lazy" class="request-avatar-img">
    <div class="heheeh">
