...
try {
    ...
    $sqlFile = "d:\VTS User\Cuong.vu\Agent work\VietinsoftWork\SQL script\redesign_MnuSCR699_decentralization_control_20260525.sql"
    ...
    Write-Host "SQL Script executed successfully on Paradise_Dev."
} catch {
