...
-- PHASE 1: Tạo các bảng liên quan nếu chưa tồn tại
...
-- PHASE 2: Seed dữ liệu cho tblTask_ComplaintTypes
DECLARE @HasIdentity BIT = OBJECTPROPERTY(OBJECT_ID('[dbo].[tblTask_ComplaintTypes]'), 'TableHasIdentity');
...
-- PHASE 3: Cài đặt/Cập nhật các Stored Procedure liên quan
...
END
GO
PRINT '[OK] Created procedure sp_Task_GetComplaintList';
GO
...
END
GO
PRINT '[OK] Created procedure sp_Task_GetComplaintList_html';
GO
...
GO
PRINT '[OK] Created procedure sp_Task_ComplaintForm';
GO
...
GO
PRINT '[OK] Created procedure sp_Task_ComplaintForm_html';
GO
...
CREATE   PROCEDURE [dbo].[sp_Task_Complaint_Resolve] (
    ...
    END
GO
PRINT '[OK] Created procedure sp_Task_Complaint_Resolve';
GO
...
CREATE   PROCEDURE [dbo].[sp_Task_Complaint_GetDataList] (
    ...
    END
GO
PRINT '[OK] Created procedure sp_Task_Complaint_GetDataList';
GO
...
GO
PRINT '[OK] Created procedure sp_Task_getComplaintTypes';
GO
...
CREATE   PROCEDURE [dbo].[sp_Task_Complaint_GetUnfinishedTasks] (
    ...
    END
GO
PRINT '[OK] Created procedure sp_Task_Complaint_GetUnfinishedTasks';
GO
...
CREATE   PROCEDURE [dbo].[sp_Task_Complaint_GetDetail] (
    ...
    END
GO
PRINT '[OK] Created procedure sp_Task_Complaint_GetDetail';
GO
...
CREATE   PROCEDURE [dbo].[sp_Task_Complaint_Submit] (
    ...
    END
GO
PRINT '[OK] Created procedure sp_Task_Complaint_Submit';
GO
-- PHASE 4: Đồng bộ cấu hình Menu, Phân quyền và Ngôn ngữ
BEGIN TRY
    BEGIN TRANSACTION;
...
-- PHASE 5: Biên dịch và Rebuild HTML cache
