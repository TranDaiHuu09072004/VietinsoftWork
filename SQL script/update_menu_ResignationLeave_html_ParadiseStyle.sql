...
CREATE OR ALTER PROCEDURE [dbo].[sp_ResignationLeave_Mobile](@LoginID int=3, @LanguageID varchar(2) ='VN', @Identity_Id varchar(36) ='')
...
async function initsp_ResignationLeave_Mobile() {
...
initsp_ResignationLeave_Mobile()
...
<style>
                ...
                :root {
                    ...
                    --vc-green-transparent005: rgba(40, 167, 69, 0.05);

                    --vc-green-transparent02: rgba(40, 167, 69, 0.2);

                    --vc-red-transparent005: rgba(220, 53, 69, 0.05);

                    --vc-red-transparent02: rgba(220, 53, 69, 0.2);
                ...
                #sp_FormEmployee #divAdvAL {
                        ...
                        align-items: center; /* Căn chỉnh dọc giữa các phần tử trong div */
                    ...
                    #sp_FormEmployee #divAdvAL .col-form-label {
                        ...
                        align-items: center; /* Đảm bảo label và span thẳng hàng */

                    }

                    #sp_FormEmployee #AdvAL {

                        margin-right: 8px; /* Khoảng cách giữa số ngày và nút ? */

                    }

                    #sp_FormEmployee .modal-body p {

                        margin-bottom: 0.75rem; /* Giãn cách các dòng trong modal */
                    ...
                    #sp_FormEmployee .modal-body strong {
                        ...
                        color: #2c3e50; /* Màu chữ đậm nổi bật */
                    ...
                    border-bottom: 1px solid #dee2e6; /* Đường viền dưới header */
                ...
                /* Bỏ height cố định cho card chính */
                ...
                #sp_FormEmployee .card-body {
                    ...
                    min-height: calc(100vh - 100px); /* Chiều cao tối thiểu */

                }



                /* Tab đăng ký - không scroll, tự động mở rộng */
...
height: auto !important;
                ...
                /* Mobile responsive - giữ nguyên như cũ */
                ...
                #sp_FormEmployee .col-form-label, #sp_FormEmployee .form-label {
          ...
          overflow: auto;
                ...
                #leave-customchosefileExpenses {

                    background-color: #00673b !important;

                }

                #sp_FormEmployee .from_day, #sp_FormEmployee .to_day {
                ...
                #sp_FormEmployee button#register_form {
                ...
                #sp_FormEmployee .validate_error_date, #sp_FormEmployee .validate_error_date0,

                #sp_FormEmployee .validate_error_date1, #sp_FormEmployee .validate_error_date2,

                #sp_FormEmployee .validate_error_shiftdate {
                ...
                #sp_FormEmployee .validate_error_date.active, #sp_FormEmployee .validate_error_date0.active,

                #sp_FormEmployee .validate_error_date1.active, #sp_FormEmployee .validate_error_date2.active,

                #sp_FormEmployee .validate_error_shiftdate.active {
    ...
    flex-direction: row;
                ...
                #sp_FormEmployee .form-check-group .form-check {
                ...
                #sp_FormEmployee .form-check-group .form-check:last-child {
     ...
     cursor: not-allowed;
                ...
                #sp_FormEmployee .section-title.detail-title {
                    ...
                    border-bottom: 2px solid #00673b;
    ...
    padding: 5px;
                ...
                #sp_FormEmployee .back-btn:hover {
                    ...
                    background-color: var(--vc-green-transparent005);
                ...
                #sp_FormEmployee .tab.active {
                    ...
                    border-bottom: 2px solid #00673b !important;
        ...
        #sp_FormEmployee .history-card:hover {
    ...
    #sp_FormEmployee .history-card .avatar-img, #sp_FormEmployee .history-card .fas.fa-user-circle {
                ...
                #sp_FormEmployee .history-card .card-content {
       ...
       gap: 10px;
                ...
                #sp_FormEmployee .history-card .time-section {
                ...
                #sp_FormEmployee .history-card .details-section p {
                ...
                #sp_FormEmployee .history-card .details-section strong {
   ...
   color: #1f2a44;
                ...
                #sp_FormEmployee .history-card .status-0 {
                ...
                #sp_FormEmployee .history-card .status-1 {
                ...
                #sp_FormEmployee .history-card .status-2 {
                ...
                #sp_FormEmployee .history-card .status-3 {
                ...
                #sp_FormEmployee .history-card .status-4 {

                    color: #22c55e;        /* Hủy thành công - màu xanh */
                ...
                #sp_FormEmployee .history-card .status-5 {

                    color: #6b7280;      /* Xin hủy đăng ký - màu gray */
              ...
              width: 50px;
                ...
                #sp_FormEmployee .text-status.blue { background-color: #c9ddf3; color: #007bff; }

         #sp_FormEmployee .text-status.gray { background-color: #e8e8e8; color: #939496; }

                #sp_FormEmployee .text-status.yellow { background-color: #f9f2e0; color: #ffc107; }

                #sp_FormEmployee .text-status.green { background-color: #e5fdf3; color: #198754; }

                #sp_FormEmployee .text-status.red { background-color: #f9d9dd; color: #dc3545; }
                ...
                /* Ch? s?a CSS liên quan đ?n modal hi?n th? file */
 ...
 margin: 0 auto;
   ...
   margin-bottom: 8px;
    ...
    #sp_FormEmployee .history-card .card-title {
      ...
      #sp_FormEmployee .employee-info .avatar-container {
                    ...
                    #sp_FormEmployee .employee-info .info-container .employeeid{
   ...
   padding-left: 16px;
    ...
    #container_approver .timeline-step .circle.blue { background-color: #007bff; }

    #container_approver .timeline-step .circle.gray { background-color: #939496; }

    #container_approver .timeline-step .circle.yellow { background-color: #ffc107; }

    #container_approver .timeline-step .circle.green { background-color: #198754; }

    #container_approver .timeline-step .circle.red { background-color: #dc3545; }
...
column-gap: 2px;
 ...
 background-color: #FDECEC;
    ...
    #sp_FormEmployee #employeeLeaveHistoryList .oa-card {
...
#sp_FormEmployee #employeeLeaveHistoryList .oa-card:hover {
...
CREATE OR ALTER PROCEDURE [dbo].[sp_ResignationLeave_html](@LoginID INT = 3, @LanguageID VARCHAR(2) = 'VN', @IdentityID varchar(36) = '')
