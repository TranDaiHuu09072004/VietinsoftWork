...
-- ============================================================
CREATE OR ALTER PROCEDURE dbo.sp_CRM_CustomerList_html
(
    @LoginID    INT          = 3,
...
PRINT '1. Da tao procedure sp_CRM_CustomerList_html.';
GO

-- Rebuild cache tự động
IF OBJECT_ID('tempdb..#Results') IS NOT NULL DROP TABLE #Results;
DELETE FROM tblHtmlScriptCache WHERE TableName = 'sp_CRM_CustomerList_html';
GO
EXEC dbo.sp_GenerateHTMLScript 'sp_CRM_CustomerList_html';
GO
