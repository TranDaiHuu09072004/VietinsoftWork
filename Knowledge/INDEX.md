...
| **tạo menu mới end-to-end / skill tạo menu / AjaxHPAParadise / gọi API hiển thị data / Hello world Vietinsoft** | [12_CreateMenu.md](12_CreateMenu.md) |
| **migrate menu / update menu / script update menu / script migrate menu / Quản lý bài học / Nhật ký công việc / copy giao diện menu / không chèn trùng quyền menu** | [13_Migrate_Menu.md](13_Migrate_Menu.md) |
...
| **renderer HTML JS an toàn / escape T-SQL → JS / quote boundary `N'...'` / Msg 257 implicit conversion / `varbinary(max)` / dynamic SQL `tblCommonControlType_Signed` / UID deterministic / script render export DB khác / `Incorrect syntax near 'function'` / `InstanceXXX is not defined` / polyfill `loadDataSourceCommon` / MERGE `tblHtmlScriptCache` 8 cột** | [17_RendererHtmlJsSafe.md](17_RendererHtmlJsSafe.md) |
