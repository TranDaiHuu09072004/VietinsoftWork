...
| [14_ParadiseStyle.md](14_ParadiseStyle.md) | **Skill** — chuẩn thiết kế giao diện ParadiseHR Web: dùng `sp_MainStyleCSSParadise`, token `--paradise-*`, không thiết lập background cho bất cứ menu nào | Hỏi về thiết kế giao diện, làm đẹp menu, refactor UI/CSS, ParadiseStyle, renderer HTML chuẩn |
...
| **thiết kế giao diện / làm đẹp menu / refactor UI / CSS menu / ParadiseStyle / `sp_MainStyleCSSParadise` / không thiết lập background / token `--paradise-*`** | [14_ParadiseStyle.md](14_ParadiseStyle.md) |
